...
function runtime.default_tests()
	return {
		...
		-- Numeric tests
		odd = function(v)
			return type(v) == "number" and math.floor(v) % 2 ~= 0
		end,
		even = function(v)
			return type(v) == "number" and math.floor(v) % 2 == 0
		end,
		...
		sameas = function(v, other)
			return rawequal(v, other)
		end,
		...
		["in"] = function(v, container)
			return runtime.contains(container, v)
		end,
...
function runtime.default_filters()
	return {
		-- String filters
		upper = function(s)
			return s and tostring(s):upper() or ""
		end,
		lower = function(s)
		...
		ltrim = function(s)
			return s and tostring(s):match("^%s*(.*)") or ""
		end,
		rtrim = function(s)
			return s and tostring(s):match("(.-)%s*$") or ""
		end,
		...
		-- HTML filters
		escape = function(s)
			return runtime.escape(s)
		end,
		e = function(s)
			return runtime.escape(s)
		end,
		safe = function(s)
			return runtime.safe(s)
		end,
