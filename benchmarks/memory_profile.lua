...
print(string.format("%-30s %8.2f KB total  %8.3f KB/op", r1.name, r1.total_kb, r1.per_iteration_kb))
...
print(string.format("%-30s %8.2f KB total  %8.3f KB/op", r2.name, r2.total_kb, r2.per_iteration_kb))
...
print(string.format("%-30s %8.2f KB total  %8.3f KB/op", r3.name, r3.total_kb, r3.per_iteration_kb))
...
print(string.format("%-30s %8.2f KB total  %8.3f KB/op", r4.name, r4.total_kb, r4.per_iteration_kb))
...
print(
	string.format(
		"  Compiled reuse is %.1fx more memory efficient than full render",
