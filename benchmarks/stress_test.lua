...
print(string.format("  Template size: %d lines, %d bytes", select(2, template_1k:gsub("\n", "\n")) + 1, #template_1k))
...
print(string.format("  100x reuse time: %.3f seconds (%.4f sec/render)", reuse_time, reuse_time / 100))
print("")
...
print(string.format("  Template size: %d lines, %d bytes", select(2, template_5k:gsub("\n", "\n")) + 1, #template_5k))
...
print(string.format("  10x reuse time: %.3f seconds (%.4f sec/render)", reuse_time, reuse_time / 10))
print("")
...
print(string.format("  Template size: %d lines, %d bytes", select(2, template_10k:gsub("\n", "\n")) + 1, #template_10k))
...
print(string.format("  5x reuse time: %.3f seconds (%.4f sec/render)", reuse_time, reuse_time / 5))
print("")
...
print(
	string.format(
		"  After compiling 100 templates: %.2f KB (+%.2f KB)",
		mem_after_compile,
		mem_after_compile - mem_before
	)
)
print(
	string.format(
		"  After rendering 100 templates: %.2f KB (+%.2f KB)",
		mem_after_render,
		mem_after_render - mem_after_compile
	)
)
